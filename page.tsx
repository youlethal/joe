      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={() => window.location.href = '/demo/services'}
              className={`text-sm font-medium transition-colors ${
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              >
                Contact
                             ...
                             <button 
                 onClick={() => window.location.href = '/demo/booking'}
                 className="w-full bg-pink-500 text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-pink-600 transition-colors"
               >
                 Book Now
               </button>
                             <button 
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              ...
              we create looks that make you feel confident and beautiful.
               ...
               <button 
                 onClick={() => window.location.href = '/demo/booking'}
                 className="bg-pink-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-pink-600 transition-colors flex items-center justify-center"
               >
                 Book Appointment
    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="bg-pink-500 text-white px-8 py-6">
              ...
              <p className="text-pink-100">Our most requested treatments</p>
            </div>
        ...
        >
          <button
            onClick={() => window.location.href = '/demo/services'}
            className="bg-pink-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-pink-600 transition-colors inline-flex items-center space-x-2"
          >
        ...
        <AnimatePresence>
          {selectedBlogPost && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -50 }}
              className="w-full bg-white rounded-2xl shadow-lg mb-12"
            >
              <div className="p-8">
                {/* Featured Image */}
                <div className="relative h-96 bg-gray-200 rounded-2xl overflow-hidden mb-8">
                  {selectedBlogPost.featured_image_url ? (
                    <img
                      src={selectedBlogPost.featured_image_url}
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="flex items-center justify-between mb-6">
                    <span className="bg-pink-100 text-pink-600 px-4 py-2 rounded-full text-sm font-medium">
                      {blogCategories.find(c => c.id === selectedBlogPost.category_id)?.name || 'Uncategorized'}
                    </span>
                    <div className="flex items-center space-x-6 text-sm text-gray-500">
                      <div className="flex items-center space-x-2">
                        <User className="w-4 h-4" />
                        <span>{selectedBlogPost.author_name}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Calendar className="w-4 h-4" />
                        <span>{new Date(selectedBlogPost.published_at || selectedBlogPost.created_at).toLocaleDateString()}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Clock className="w-4 h-4" />
                        <span>{selectedBlogPost.reading_time} min read</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@elegancesalon.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
